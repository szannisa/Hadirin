  ...
  <header class="bg-[#33415C] shadow-sm">
    <div class="max-w-7xl mx-auto px-4 py-3 sm:py-4 sm:px-6 lg:px-8 flex justify-between items-center">
      <div class="flex items-center space-x-3 sm:space-x-4">
        <a href="{{ route('users.index') }}" class="text-white hover:text-gray-200 transition-colors">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
      ...
      <div class="px-6 py-4 border-b bg-gradient-to-r from-[#33415C] to-[#33415C]">
        <h3 class="text-lg font-semibold text-white">
          <i class="fas fa-user-plus mr-2"></i>Informasi Pengguna
        </h3>
      </div>
      ...
      <div class="p-6">
        ...
        <form action="{{ route('users.store') }}" method="POST" class="space-y-6">
          ...
          <div class="flex items-center justify-end pt-6 border-t border-gray-200">
            ...
            >
              <i class="fas fa-save mr-2"></i> Tambah Pengguna
            </button>
          </div>
        </form>
      </div>
